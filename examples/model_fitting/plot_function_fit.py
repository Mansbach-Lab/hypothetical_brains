...
# ------------
#
# First, we'll load some data into hypotheticalbrains.
...
# ---------------
#
# With hypotheticalbrains, models are created with the :ref:Model class.
